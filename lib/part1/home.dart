...
import '../part1/drawLib/src/drawing_board.dart';
import '../part1/drawLib/src/drawing_controller.dart';
import '../part1/drawLib/src/paint_contents/eraser.dart';
import '../part1/drawLib/src/paint_contents/paint_content.dart';
import '../part1/drawLib/src/paint_contents/simple_line.dart';
import '../part1/drawLib/src/paint_contents/straight_line.dart';
import '../part1/drawLib/src/paint_extension/ex_offset.dart';
import '../part1/drawLib/src/paint_extension/ex_paint.dart';
...
class StickerContent extends PaintContent {
  StickerContent(this.image, {this.imageUrl = ''});
  ...
  factory StickerContent.fromJson(Map<String, dynamic> data) {
    return StickerContent.data(
      startPoint: jsonToOffset(data['startPoint'] as Map<String, dynamic>),
      size: jsonToOffset(data['size'] as Map<String, dynamic>),
      imageUrl: data['imageUrl'] as String,
      image: data['image'] as ui.Image,
...
class DrawPart1 extends StatefulWidget {
  const DrawPart1({Key? key}) : super(key: key);

  @override
  State<DrawPart1> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<DrawPart1> {
